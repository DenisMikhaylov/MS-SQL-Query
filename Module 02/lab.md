...
4. В окне запроса выделите оператор USE TSQL;, а затем щелкните Выполнить.MCT USE ONLY. ИСПОЛЬЗОВАНИЕ СТУДЕНТАМИ ЗАПРЕЩЕНО
L3-2 Запрос данных с помощью Transact-SQL

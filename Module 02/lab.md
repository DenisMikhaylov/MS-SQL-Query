...
1. Убедитесь, что виртуальные машины 20761C-MIA-DC и 20761C-MIA-SQL запущены, а затем войдите в систему 20761C-MIA-SQL как ADVENTUREWORKS\Student с паролем Pa55w.rd.
...
только эту часть. Если вы нажмете Выполнить, не выбрав ни одной части кода, будет выполнен весь скрипт T-SQL. Если вы выделите определенную часть кода по ошибке, SQL Server попытается выполнить только эту часть.
